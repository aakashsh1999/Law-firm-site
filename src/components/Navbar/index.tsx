...
function NavBar() {
  return (
    <Disclosure as="header" className="bg-[#0B284C] t shadow">
      <div className="mx-auto">
        <div className="relative flex h-16 justify-between   px-2 sm:px-4  lg:px-8">
          ...
          <div className="relative z-0 flex flex-1 items-center justify-center px-2 sm:absolute sm:inset-0">
            <div className="grid w-full grid-cols-1 sm:max-w-lg">
              <input
                name="search"
                type="search"
                placeholder="Search"
      ...
      <DisclosurePanel as="nav" aria-label="Global" className="lg:hidden">
        ...
        <div className="border-t border-gray-200 pb-3 pt-4">
          ...
          <div className="mt-3 space-y-1 px-2 bg-gray-400">
